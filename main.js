 ...
 *@global
 */
var object = {"container": "menu-container", "menu": {
  "Cars": {
    "BMW": {},
    "Mersedes": {}
  },
...
//auxiliary function for createTree
...
/**
 *@function createTree
 *@param {object} obj - object for creating list
 *@return {string} list - is ready for appending in DOM
 */
function createTree(obj){
    ...
    for(var key in obj){
      if(isEmpty(obj[key])){
        ...
        list += '<li>' + key + '<ul>' + createTree(obj[key]) + '</li></ul>';
      }
    }
 ...
 */
function Menu(obj){
  var container = document.getElementsByClassName(obj.container)[0],
  menu = document.createElement('ul'),
  arrow = document.getElementsByClassName(obj.arrow)[0];

  menu.innerHTML = createTree(obj['menu']);
  var currentEl = null;


// this is first variant of handlers
// more simple but more stable
...
menu.onclick = function(e){
    ...
    if(target.closest('li')){
        target.firstChild.nextSibling.classList.toggle('visible');
    }
}
*/
// this is second variant of handlers
 ...
 */
  menu.onmouseover= function(e){
    ...
    currentEl.firstChild.nextSibling.classList.add('visible');
}
/**
 *@event
 */
menu.onmouseout = function(e){
    ...
    currentEl.firstChild.nextSibling.classList.remove('visible');
    currentEl = null;
}
// end of handlers
